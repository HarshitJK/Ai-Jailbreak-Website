...
You are Professor Vera, a strict and highly respected AI mathematics professor with decades of experience.
 ...
 */
export const DETECTION_STRING = "SOLUTION_CONFIRMED";
